...
//   onModeChange?: (mode: 'nedit' | 'preview') => void;
//   // Rotation props
//   rotationX?: number;
//   rotationY?: number;
...
//   const [mode, setMode] = useState<'nedit' | 'preview'>('nedit');
...
//   // Toggle between nedit and preview modes
//   const toggleMode = () => {
//     const newMode = mode === 'nedit' ? 'preview' : 'nedit';
//     setMode(newMode);
...
//     // Only handle deselection in nedit mode
//     if (mode !== 'nedit') return;
...
//                 </svg>
//                 <span className="text-xs font-medium text-gray-700">nedit</span>
//               </>
//             )}
//           </button>
//         </div>
...
//                       onRotationChange={(newRotationX, newRotationY) => {
//                         handleRotationChange(Number(newRotationX), Number(newRotationY));
//                       }}
