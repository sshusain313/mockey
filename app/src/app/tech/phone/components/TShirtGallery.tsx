...
export function TShirtGallery({ activeCategory, setActiveCategory, products = [], uploadedDesign }: TShirtGalleryProps) {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-3 sm:p-4 w-full">
      <div className="mb-4 sm:mb-6 overflow-x-auto whitespace-nowrap pb-2">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
        {mockups.map((mockup) => (
          <div 
            key={mockup.id} 
            className="rounded-lg overflow-hidden border border-gray-200 group hover:shadow-md transition-shadow cursor-pointer"
            onClick={() => {
          ...
          >
            <div className="relative aspect-square bg-gray-100">
              ...
              <div className="absolute bottom-2 right-2 bg-white rounded-full p-1 opacity-0 group-hover:opacity-100 transition-opacity hidden sm:block">
        ...
        {Array.from({ length: 4 }).map((_, index) => (
          <div key={`placeholder-${index}`} className="rounded-lg overflow-hidden border border-gray-200 hover:shadow-md transition-shadow">
            <div className="aspect-square bg-gray-100"></div>
            <div className="p-2 sm:p-3">
              <h3 className="text-xs sm:text-sm font-medium text-gray-900 truncate">T-shirt Mockup Example</h3>
              <p className="text-xs text-gray-500 mt-1 hidden sm:block">Example template</p>
              <p className="text-[10px] text-gray-500 mt-1 sm:hidden">Example</p>
            </div>
          </div>
        ))}
      </div>
      ...
      <section className="bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-sm max-w-7xl mx-4 sm:mx-10 my-6 sm:my-10 flex flex-col md:flex-row gap-4 sm:gap-6 items-center">
  ...
  <div className="md:w-1/3 w-full">
    ...
    />
      ...
      <FAQSection />
      <section className='max-w-7xl mx-4 sm:mx-10 mt-6 sm:mt-10 relative overflow-hidden rounded-md mb-6 sm:mb-10' style={{ height: '200px', maxHeight: '300px' }}>
