...
export function TShirtSidebar({ selectedColor, setSelectedColor, uploadedDesign, setUploadedDesign, onClose }: TShirtSidebarProps) {
  ...
  return (
    <div className="w-full md:w-70 border-r border-gray-200 flex-shrink-0 bg-white overflow-y-auto">
      ...
      <div className="border-b border-gray-200">
        ...
        {expanded.apparel && (
          <div className="py-1">
            {["Tshirt", "TankTop", "Hoodie", "Sweatshirt", "Jacket", "Crop Top", "Apron", "Scarf", "Jersey"].map((item) => (
              <Link 
                key={item} 
                href={`/apparel/${item.toLowerCase().replace(/\s+/g, "-")}`} // Generate dynamic links
      ...
      <div className="border-b border-gray-200">
        ...
        {expanded.accessories && (
          <div className="py-1">
            {["Beanie", "Gaming Pad", "Phone Cover", "Totebag", "Cap"].map((item) => (
              <Link 
                key={item} 
                href={`/accessories/${item.toLowerCase().replace(/\s+/g, "-")}`} // Generate dynamic links
                className="px-4 py-2 w-full text-left text-gray-700 hover:bg-gray-50 block"
              >
                {item}
              </Link>
      ...
      <div className="border-b border-gray-200">
        ...
        {expanded.homeLiving && (
          <div className="py-1">
            {["Mug", "Cusion", "Frame", "Can", "Coaster"].map((item) => (
              <Link 
                key={item} 
                href={`/home-living/${item.toLowerCase().replace(/\s+/g, "-")}`} // Generate dynamic links
                className="px-4 py-2 w-full text-left text-gray-700 hover:bg-gray-50 block"
              >
                {item}
              </Link>
      ...
      <div className="border-b border-gray-200">
        ...
        {expanded.print && (
          <div className="py-1">
            {["Poster", "Flyer", "Business Card", "Sticker"].map((item) => (
              <Link 
                key={item} 
                href={`/print/${item.toLowerCase().replace(/\s+/g, "-")}`} // Generate dynamic links
                className="px-4 py-2 w-full text-left text-gray-700 hover:bg-gray-50 block"
              >
                {item}
              </Link>
      ...
      <div className="border-b border-gray-200">
        ...
        {expanded.packaging && (
          <div className="py-1">
            {["Boxe", "Pouch", "Bottle", "Tube", "Cosmetic", "Dropper Bottle"].map((item) => (
              <Link 
                key={item} 
                href={`/packaging/${item.toLowerCase().replace(/\s+/g, "-")}`} // Generate dynamic links
                className="px-4 py-2 w-full text-left text-gray-700 hover:bg-gray-50 block"
              >
                {item}
              </Link>
      ...
      <div className="border-b border-gray-200">
        ...
        {expanded.tech && (
          <div className="py-1">
            {["Phone", "Laptop", "iPhone", "Macbook", "iPad"].map((item) => (
              <Link 
                key={item} 
                href={`/tech/${item.toLowerCase().replace(/\s+/g, "-")}`} // Generate dynamic links
                className="px-4 py-2 w-full text-left text-gray-700 hover:bg-gray-50 block"
              >
                {item}
              </Link>
      ...
      <div className="border-b border-gray-200">
        ...
        {expanded.jewelry && (
          <div className="py-1">
            {["Rings", "Necklaces", "Earrings"].map((item) => (
              <Link 
                key={item} 
                href={`/jewelry/${item.toLowerCase().replace(/\s+/g, "-")}`} // Generate dynamic links
                className="px-4 py-2 w-full text-left text-gray-700 hover:bg-gray-50 block"
              >
                {item}
              </Link>
