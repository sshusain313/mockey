 ...
 */
export const getCoasterProducts = cache(async () => {
  let products = [];
  ...
  try {
    ...
    const query = {
      ...
      $or: [
        { subcategory: { $regex: 'coaster', $options: 'i' } },
        { subcategory: { $regex: 'coster', $options: 'i' } }
        // { subcategory: { $regex: 'beer can', $options: 'i' } },
        // { subcategory: { $regex: 'energy drink can', $options: 'i' } },
